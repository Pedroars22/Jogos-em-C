...
void exibeTabuleiro (char tabuleiro[3][3]){
     ...
     //Exibe o tabuleiro com suas linhas e colunas quebrando a linha
    int linha,coluna;
    cout << "\n";
    for(linha = 0; linha < 3; linha++){
        for(coluna = 0; coluna < 3; coluna++){
...
void jogo(string nomeDoJogadorUm, string nomeDoJogadorDois, int pontuacaoJogadorUm, int pontuacaoJogadorDois){
    ...
    while(rodada < 9 && estadoDeJogo == 1){
        ...
        //Exibe painel numerico de posição
        exibeInstrucoes();
        ...
        //Confere se chegou o fim do jogo
...
void menuInicial(){
    ...
    //Mostra o menu novamente em quanto a opção for invalida
